...
<div class=" flex items-center pt-24 justify-between  ">
  <div class="relative w-full max-w-lg ">
    ...
    <div class="absolute -bottom-8 left-20 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-80 animate-blob animation-delay-2000"></div>
